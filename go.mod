...
require (
	github.com/RedHatInsights/clowder v0.61.0
	github.com/RedHatInsights/frontend-operator v0.1.4
...
require (
	github.com/RedHatInsights/cyndi-operator v0.1.9 // indirect
	github.com/RedHatInsights/go-difflib v1.0.0 // indirect
	github.com/RedHatInsights/strimzi-client-go v0.34.2 // indirect
	...
	github.com/kedacore/keda/v2 v2.8.2 // indirect
